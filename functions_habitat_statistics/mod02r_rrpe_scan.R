################################################################################
#   mod02r_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
mod02r_rrpe_scan <- function(
  ...
  n_half_hab0_log10_range <- log10((lhsvals[, 2] * (10^n_half_hab0_log10_range[2] - 10^n_half_hab0_log10_range[1])) + 10^n_half_hab0_log10_range[1])
  n_half_hab1_log10_range <- log10((lhsvals[, 3] * (10^n_half_hab1_log10_range[2] - 10^n_half_hab1_log10_range[1])) + 10^n_half_hab1_log10_range[1])
