################################################################################
#   mod07h_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
mod07h_rrpe_scan <- function(
  ...
  a_intercept_log10_range <- log10((lhsvals[, 3] * (10^a_intercept_log10_range[2] - 10^a_intercept_log10_range[1])) + 10^a_intercept_log10_range[1])
  a_slope_range           <-       (lhsvals[, 4] * (             a_slope_range[2] -              a_slope_range[1])) +              a_slope_range[1]
