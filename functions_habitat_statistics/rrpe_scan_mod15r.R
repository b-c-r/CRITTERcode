...
#' @param n_half_range_intercept_log10 float; intercept of log10 half saturation density, two values.
#' @param n_half_range_slope_log10 float; slope of log10 half saturation density, two values.
...
rrpe_scan_mod15r <- function(
    ...
    f_max_range_3_log10,
    f_max_range_4_log10,
    n_half_range_intercept_log10,
    n_half_range_slope_log10,
    t_end = 1,
    no_lhs_samples = 1000
){
  ...
  nlls <- foreach::foreach(
    ...
    .combine = "c") %do% {
      ...
      nll <- rrpe_nll_mod15r(
          ...
          n_half_intercept_log10 = n_half_range_intercept_log10[i],
          n_half_slope_log10 = n_half_range_slope_log10[i],
          t_end = t_end
        )
  ...
  sel_parms <- data.frame(
    ...
    n_half_intercept_log10 = n_half_range_intercept_log10[nlls == min(nlls)],
    n_half_slope_log10 = n_half_range_slope_log10[nlls == min(nlls)],
