################################################################################
#   mod15r_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
mod15r_rrpe_scan <- function(
  ...
  n_half_intercept_log10_range <- log10((lhsvals[, 6] * (10^n_half_intercept_log10_range[2] - 10^n_half_intercept_log10_range[1])) + 10^n_half_intercept_log10_range[1])
  n_half_slope_range     <-       (lhsvals[, 7] * (       n_half_slope_range[2] -        n_half_slope_range[1])) +        n_half_slope_range[1]
