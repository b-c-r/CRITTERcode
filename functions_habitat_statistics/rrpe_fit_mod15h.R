...
rrpe_fit_mod15h <- function(
  ...
  initial_guess <- rrpe_scan_mod15h(
    ...
    p = p,
    t_h_range_0_log10 = 1 / log10(c(1, max(n_eaten[complexity == 0]))/t_end),
    t_h_range_1_log10 = 1 / log10(c(1, max(n_eaten[complexity == 1]))/t_end),
    t_h_range_2_log10 = 1 / log10(c(1, max(n_eaten[complexity == 2]))/t_end),
    t_h_range_3_log10 = 1 / log10(c(1, max(n_eaten[complexity == 3]))/t_end),
    t_h_range_4_log10 = 1 / log10(c(1, max(n_eaten[complexity == 4]))/t_end),
    a_range_intercept_log10 = log10(c(1 / mean(n_initial[n_rings == 0]), max(n_eaten[n_rings == 0]) / mean(n_initial[n_rings == 0])) / t_end),
