################################################################################
#   mod09r_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
mod09r_rrpe_fit <- function(
  ...
  initial_guess <- mod09r_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
    n_rings = n_rings,
  ...
  message(paste("n_half_log10: ", round(bbmle::coef(fit[[1]])[4],2)))
  ...
  while(witer <= witer_max){
    ...
    message(paste("n_half_log10: ", round(bbmle::coef(fit[[witer]])[4],2)))
