################################################################################
#   mod06h_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
#' 
#' @include rrpe_sim.R
#' @include mod06h_rrpe_nll.R
#' @include mod06h_rrpe_scan.R
#' 
...
#' # https://github.com/b-c-r/CRITTERcode/examples_habitat_statistics/examples_habitat_statistics/mod06h_examples.R
#' 

mod06h_rrpe_fit <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
  ...
  initial_guess <- mod06h_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
