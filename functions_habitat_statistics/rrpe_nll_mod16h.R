################################################################################
#   rrpe_nll_mod16h: estimates the negative log-likelihood of mod16h           #
#                                                                              #
#    Copyright (C) 2025                                                        #
...
#' 
#'
#' @description `rrpe_nll_mod16h` calculates the negative log likelihood of
...
#' @param a_0_log10 a for the respective complexity level, single value.
#' @param a_1_log10 a for the respective complexity level, single value.
#' @param a_2_log10 a for the respective complexity level, single value.
#' @param a_3_log10 a for the respective complexity level, single value.
#' @param a_4_log10 a for the respective complexity level, single value.
...
#' 
#' fit_ie_mod16h <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod16h,
#'   start = list(
...
#'     a_0_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 0])),
#'     a_1_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 1])),
#'     a_2_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 2])),
#'     a_3_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 3])),
#'     a_4_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 4]))
#'   ),
#'   fixed = list(
#'     t_end = 1,
#'     p = 1
...
#' )
#' 
#' bbmle::summary(fit_ie_mod16h)
#' 
#' #############################################################################
#' 
#' fr_data_ng <- subset(fr_data, predator == "Notonecta glauca")
#' 
#' fit_ng_mod16h <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod16h,
#'   start = list(
...
#'     a_0_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 0])),
#'     a_1_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 1])),
#'     a_2_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 2])),
#'     a_3_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 3])),
#'     a_4_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 4]))
#'   ),
#'   fixed = list(
#'     t_end = 1,
#'     p = 1
...
#' )
#' 
#' bbmle::summary(fit_ng_mod16h)
#' 

rrpe_nll_mod16h <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
