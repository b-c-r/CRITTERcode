################################################################################
#   mod14h_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
mod14h_rrpe_scan <- function(
  ...
  a_hab0_log10_range <- log10((lhsvals[, 6] * (10^a_hab0_log10_range[2] - 10^a_hab0_log10_range[1])) + 10^a_hab0_log10_range[1])
  a_hab1_log10_range <- log10((lhsvals[, 7] * (10^a_hab1_log10_range[2] - 10^a_hab1_log10_range[1])) + 10^a_hab1_log10_range[1])
