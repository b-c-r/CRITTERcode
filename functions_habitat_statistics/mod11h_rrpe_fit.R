################################################################################
#   mod11h_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
#'
#' @include rrpe_sim.R
#' @include mod11h_rrpe_nll.R
#' @include mod11h_rrpe_scan.R
#'
...
#' # https://github.com/b-c-r/CRITTERcode/examples_habitat_statistics/examples_habitat_statistics/mod11h_examples.R
#' 

mod11h_rrpe_fit <- function(
    n_eaten,
    n_initial,
    n_rings,
    complexity = NA,
  ...
  initial_guess <- mod11h_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
    n_rings = n_rings,
    p = p,
