################################################################################
#   mod08r_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
#' # https://github.com/b-c-r/CRITTERcode/examples_habitat_statistics/examples_habitat_statistics/mod08r_examples.R
#' 

mod08r_rrpe_scan <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
