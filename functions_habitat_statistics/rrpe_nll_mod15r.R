################################################################################
#   rrpe_nll_mod15r: estimates the negative log-likelihood of Model 16r        #
#                                                                              #
#    Copyright (C) 2025                                                        #
...
#' 
#'
#' @description `rrpe_nll_mod15r` calculates the negative log likelihood of
...
#'     n_half_intercept_log10 = log10(mean(fr_data_ie$n_initial[fr_data_ie$ring_count == 0])),
#'     n_half_slope_log10 = 0
#'   ),
#'   fixed = list(
#'     t_end = 1,
#'     p = 1
...
#' )
#' 
#' bbmle::summary(fit_ie_mod15r)
#' 
#' #############################################################################
#' 
#' fr_data_ng <- subset(fr_data, predator == "Notonecta glauca")
#' 
#' fit_ng_mod15r <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod15r,
#'   start = list(
...
#'     n_half_intercept_log10 = log10(mean(fr_data_ng$n_initial[fr_data_ng$ring_count == 0])),
#'     n_half_slope_log10 = 0
#'   ),
#'   fixed = list(
#'     t_end = 1,
