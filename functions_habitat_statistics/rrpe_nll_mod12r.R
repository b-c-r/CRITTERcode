################################################################################
#   rrpe_nll_mod12r: estimates the negative log-likelihood of Model 16r        #
#                                                                              #
#    Copyright (C) 2025                                                        #
...
#' 
#'
#' @description `rrpe_nll_mod12r` calculates the negative log likelihood of
...
#' @param f_max_intercept_log10 float; intercept of log10 f_max, single value.
#' @param f_max_slope_log10 float; slope of log10 f_max, single value.
#' @param n_half_0_log10 n_half for the respective complexity level, single value.
#' @param n_half_1_log10 n_half for the respective complexity level, single value.
#' @param n_half_2_log10 n_half for the respective complexity level, single value.
#' @param n_half_3_log10 n_half for the respective complexity level, single value.
#' @param n_half_4_log10 n_half for the respective complexity level, single value.
...
#' 
#' fit_ie_mod12r <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod12r,
#'   start = list(
#'     f_max_intercept_log10  = log10(max(fr_data_ie$n_eaten[fr_data_ie$complexity_level == 0])),
#'     f_max_slope_log10      = 0,
#'     n_half_0_log10         = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 0])),
#'     n_half_1_log10         = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 1])),
#'     n_half_2_log10         = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 2])),
#'     n_half_3_log10         = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 3])),
#'     n_half_4_log10         = log10(mean(fr_data_ie$n_initial[fr_data_ie$complexity_level == 4]))
#'   ),
#'   fixed = list(
#'     t_end = 1,
#'     p = 1
...
#' )
#' 
#' bbmle::summary(fit_ie_mod12r)
#' 
#' #############################################################################
#' 
#' fr_data_ng <- subset(fr_data, predator == "Notonecta glauca")
#' 
#' fit_ng_mod12r <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod12r,
#'   start = list(
#'     f_max_intercept_log10  = log10(max(fr_data_ng$n_eaten[fr_data_ng$complexity_level == 0])),
#'     f_max_slope_log10      = 0,
#'     n_half_0_log10         = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 0])),
#'     n_half_1_log10         = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 1])),
#'     n_half_2_log10         = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 2])),
#'     n_half_3_log10         = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 3])),
#'     n_half_4_log10         = log10(mean(fr_data_ng$n_initial[fr_data_ng$complexity_level == 4]))
#'   ),
#'   fixed = list(
#'     t_end = 1,
#'     p = 1
...
rrpe_nll_mod12r <- function(
  ...
  try({
    eaten_simulated <- foreach::foreach(
      ...
      if(complexity[i] == 0){
        n_half_log10 <- n_half_0_log10
      }
      if(complexity[i] == 1){
        n_half_log10 <- n_half_1_log10
      }
      if(complexity[i] == 2){
        n_half_log10 <- n_half_2_log10
      }
      if(complexity[i] == 3){
        n_half_log10 <- n_half_3_log10
      }
      if(complexity[i] == 4){
        n_half_log10 <- n_half_4_log10
      }
