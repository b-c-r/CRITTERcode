################################################################################
#   mod05h_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
mod05h_rrpe_fit <- function(
  ...
  initial_guess <- mod05h_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
  ...
  while(witer <= witer_max){
    ...
    message(paste("a_log10: "       , round(bbmle::coef(fit[[witer]])[4],2)))
