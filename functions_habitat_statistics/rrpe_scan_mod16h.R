################################################################################
#   rrpe_parms_scan_mod16h: scans for reasonable starting parameters           #
#                                                                              #
...
################################################################################
#'
#' @description `rrpe_parms_scan_mod16h` creates Latin hypercube samples for the
...
#'     `rrpe_parms_scan_mod16h` requires the lhs package (Carnell 2024).
#' 
...
#' @param a_range_range_0_log10 A range for a for the respective complexity level, two values.
#' @param a_range_range_1_log10 A range for a for the respective complexity level, two values.
#' @param a_range_range_2_log10 A range for a for the respective complexity level, two values.
#' @param a_range_range_3_log10 A range for a for the respective complexity level, two values.
#' @param a_range_range_4_log10 A range for a for the respective complexity level, two values.
...
#' source(here::here("functions_habitat_statistics", "rrpe_nll_mod16h.R"))
#' source(here::here("functions_habitat_statistics", "rrpe_scan_mod16h.R"))
#' 
...
#'   a_range_0_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 0]))),
#'   a_range_1_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 1]))),
#'   a_range_2_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 2]))),
#'   a_range_3_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 3]))),
#'   a_range_4_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 4]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 
...
#'   a_range_0_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 0]))),
#'   a_range_1_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 1]))),
#'   a_range_2_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 2]))),
#'   a_range_3_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 3]))),
#'   a_range_4_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 4]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 

rrpe_scan_mod16h <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
  ...
  a_range_0_log10   <- log10((lhsvals[, 6] * (  10^a_range_0_log10[2]   - 10^a_range_0_log10[1]))   + 10^a_range_0_log10[1])
  a_range_1_log10   <- log10((lhsvals[, 7] * (  10^a_range_1_log10[2]   - 10^a_range_1_log10[1]))   + 10^a_range_1_log10[1])
  a_range_2_log10   <- log10((lhsvals[, 8] * (  10^a_range_2_log10[2]   - 10^a_range_2_log10[1]))   + 10^a_range_2_log10[1])
  a_range_3_log10   <- log10((lhsvals[, 9] * (  10^a_range_3_log10[2]   - 10^a_range_3_log10[1]))   + 10^a_range_3_log10[1])
  a_range_4_log10   <- log10((lhsvals[,10] * (  10^a_range_4_log10[2]   - 10^a_range_4_log10[1]))   + 10^a_range_4_log10[1])
