...
rrpe_scan_mod16h <- function(
  ...
  a_0_log10_range   <- log10((lhsvals[, 6] * (  10^a_0_log10_range[2]   - 10^a_0_log10_range[1]))   + 10^a_0_log10_range[1])
  a_1_log10_range   <- log10((lhsvals[, 7] * (  10^a_1_log10_range[2]   - 10^a_1_log10_range[1]))   + 10^a_1_log10_range[1])
  a_2_log10_range   <- log10((lhsvals[, 8] * (  10^a_2_log10_range[2]   - 10^a_2_log10_range[1]))   + 10^a_2_log10_range[1])
  a_3_log10_range   <- log10((lhsvals[, 9] * (  10^a_3_log10_range[2]   - 10^a_3_log10_range[1]))   + 10^a_3_log10_range[1])
  a_4_log10_range   <- log10((lhsvals[,10] * (  10^a_4_log10_range[2]   - 10^a_4_log10_range[1]))   + 10^a_4_log10_range[1])
