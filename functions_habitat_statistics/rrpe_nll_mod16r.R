################################################################################
#   rrpe_nll_mod16r: estimates the negative log-likelihood of Model 16r        #
#                                                                              #
#    Copyright (C) 2025                                                        #
...
#' )
#' 
#' bbmle::summary(fit_ie_mod16r)
#' 
#' #############################################################################
#' 
#' fr_data_ng <- subset(fr_data, predator == "Notonecta glauca")
#' 
#' fit_ng_mod16r <- bbmle::mle2(
#'   minuslogl = rrpe_nll_mod16r,
#'   start = list(
...
#' )
#' 
#' bbmle::summary(fit_ng_mod16r)
#' 

rrpe_nll_mod16r <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
