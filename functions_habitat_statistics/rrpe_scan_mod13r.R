...
################################################################################
#'
#' @description `rrpe_parms_scan_mod13r` creates Latin hypercube samples for the
...
#'     `rrpe_parms_scan_mod13r` requires the lhs package (Carnell 2024).
#' 
...
#' @param n_half_range_log10 A range for n_half, two values.
...
#'   n_half_range_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 0]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 
...
#'   n_half_range_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 0]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 
...
rrpe_scan_mod13r <- function(
  ...
  n_half_range_log10  <- log10((lhsvals[, 6] * ( 10^n_half_range_log10[2] -  10^n_half_range_log10[1])) +  10^n_half_range_log10[1])
