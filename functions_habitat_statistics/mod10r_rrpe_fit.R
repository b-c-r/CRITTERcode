################################################################################
#   mod10r_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
mod10r_rrpe_fit <- function(
  ...
  initial_guess <- mod10r_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
    n_rings = n_rings,
    complexity  = complexity,
    p = p,
    f_max_intercept_log10_range = log10(f_max_hab0_range),
