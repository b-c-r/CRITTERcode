################################################################################
#   mod01r_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
#' # https://github.com/b-c-r/CRITTERcode/examples_habitat_statistics/examples_habitat_statistics/mod01r_examples.R
#' 
...
mod01r_rrpe_scan <- function(
  ...
  n_half_log10_range <- log10((lhsvals[, 2] * (10^n_half_log10_range[2] - 10^n_half_log10_range[1])) + 10^n_half_log10_range[1])
