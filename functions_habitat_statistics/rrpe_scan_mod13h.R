################################################################################
#   rrpe_parms_scan_mod13h: scans for reasonable starting parameters           #
#                                                                              #
...
################################################################################
#'
#' @description `rrpe_parms_scan_mod13h` creates Latin hypercube samples for the
...
#'     `rrpe_parms_scan_mod13h` requires the lhs package (Carnell 2024).
#' 
...
#' source(here::here("functions_habitat_statistics", "rrpe_nll_mod13h.R"))
#' source(here::here("functions_habitat_statistics", "rrpe_scan_mod13h.R"))
#' 
...
#'   a_range_log10 = log10(c(1, max(fr_data_ie$n_initial[fr_data_ie$complexity_level == 0]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 
...
#'   a_range_log10 = log10(c(1, max(fr_data_ng$n_initial[fr_data_ng$complexity_level == 0]))),
#'   t_end = 1,
#'   no_lhs_samples = 100
#' )
#' 

rrpe_scan_mod13h <- function(
    n_eaten,
    n_initial,
    complexity,
    p = 1,
