################################################################################
#   mod10r_rrpe_scan: scans for reasonable starting parameters                 #
#                                                                              #
...
#' # https://github.com/b-c-r/CRITTERcode/examples_habitat_statistics/examples_habitat_statistics/mod10r_examples.R
#' 

mod10r_rrpe_scan <- function(
    n_eaten,
    n_initial,
    n_rings,
    complexity,
