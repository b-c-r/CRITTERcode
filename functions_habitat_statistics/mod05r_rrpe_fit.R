################################################################################
#   mod05r_rrpe_fit: fitting the RRPE to data                                  #
#                                                                              #
...
#' 
#' @include rrpe_sim.R
#' @include mod05r_rrpe_nll.R
#' @include mod05r_rrpe_scan.R
#' 
...
mod05r_rrpe_fit <- function(
  ...
  initial_guess <- mod05r_rrpe_scan(
    n_eaten = n_eaten,
    n_initial = n_initial,
