################################################################################
#   Example code to fit mod04r to data                                         #
#                                                                              #
...
################################################################################
## example for: mod04r_rrpe_nll.R

fit_ie_mod04r <- bbmle::mle2(                                                   # mle2 - the maximum likelihood estimator from the bbmle package
  minuslogl = mod04r_rrpe_nll,                                                  # mle2 requires the nll function for optimization
  start = list(
...
bbmle::summary(fit_ie_mod04r)                                                   # shows the summary table


################################################################################
## example for: mod04r_rrpe_scan.R
...
bbmle::summary(mod04r_fit_ie)                                                   # shows the summary table of the best fit
bbmle::AIC(mod04r_fit_ie)                                                       # shows the AIC of the best fit
BIC(mod04r_fit_ie)                                                              # shows the BIC of the best fit
