...
rrpe_scan_mod13h(
 ...
 complexity  = fr_data_ie$complexity_level,                                     # data: complexity levels
 p = 1,                                                                         # number of predators in the experiment: here 1 predator per vessel
 t_h_range_0_log10 = c(.1,0.5),                                                 # two values, the range, handling time at complexity level 0 (log10 scale)
 t_h_range_1_log10 = c(.1,0.5),                                                 # two values, the range, handling time at complexity level 1 (log10 scale)
 t_h_range_2_log10 = c(.1,0.5),                                                 # two values, the range, handling time at complexity level 2 (log10 scale)
 t_h_range_3_log10  = c(.1,0.5),                                                # two values, the range, handling time at complexity level 3 (log10 scale)
 t_h_range_4_log10 = c(.1,0.5),                                                 # two values, the range, handling time at complexity level 4 (log10 scale)
