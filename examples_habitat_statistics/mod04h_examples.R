################################################################################
#   Example code to fit mod04h to data                                         #
#                                                                              #
...
################################################################################
## example for: mod04h_rrpe_nll.R

fit_ie_mod04h <- bbmle::mle2(                                                   # mle2 - the maximum likelihood estimator from the bbmle package
  minuslogl = mod04h_rrpe_nll,                                                  # mle2 requires the nll function for optimization
  start = list(
...
bbmle::summary(fit_ie_mod04h)                                                   # shows the summary table


################################################################################
## example for: mod04h_rrpe_scan.R
...
bbmle::summary(mod04h_fit_ie)                                                   # shows the summary table of the best fit
bbmle::AIC(mod04h_fit_ie)                                                       # shows the AIC of the best fit
BIC(mod04h_fit_ie)                                                              # shows the BIC of the best fit
